...
plt.plot([0, 2*np.sqrt(e_values[1])*e_vectors[0,1]], [0, 2*np.sqrt(e_values[1])*e_vectors[1,1]], color='red', linewidth=2)
plt.plot([0, 2*np.sqrt(e_values[0])*e_vectors[0,0]], [0, 2*np.sqrt(e_values[0])*e_vectors[1,0]], color='green', linewidth=2)
